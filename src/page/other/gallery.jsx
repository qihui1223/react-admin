...
class GalleryDemo extends Component{
	...
	render(){
		...
		return(
			<div>
				<CustomBreadcrumb arr={['其他','画廊']}/>
        		<TypingCard source={cardContent} height={230}/>
                <Card bordered={false}>
                    <Button style={styles.btnRight} onClick={()=>this.shuffle.filter()}>全部</Button>
                    <Button style={styles.btnRight} onClick={()=>this.shuffle.filter('scenery')}>风景</Button>
                    <Button style={styles.btnRight} onClick={()=>this.shuffle.filter('nature')}>自然</Button>
                    <Button style={styles.btnRight} onClick={()=>this.shuffle.filter('other')}>其他</Button>
                </Card>
